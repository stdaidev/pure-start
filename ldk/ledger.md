...
| F6.2 | Cooldown por lead: nao enviar para telefone que ja teve contato inbound recente. Bloqueio duro no create/tick + flag opcional por campanha "ignorar quem contactou nos ultimos X" com unidade selecionavel (horas/dias) | medio | idea | P2 | |
