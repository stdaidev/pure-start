...
| Fabc | Anti-ban por conexao: cota hourly/daily GLOBAL por WhatsApp, gate no worker antes de enviar | alto | partial | P2 | ldk/features/fabc-antiban-conexao/proof.md |
