...
|----|---------|------|-------|----------------|---------------|
| F0 | Design system dark terminal/HUD (tokens OKLCH, fontes Space Grotesk/JetBrains Mono/Inter, glass cards, brackets, grid sutil, sem animacao sobre texto) | baixo | planned | P1 | |
| F1 | Base: schema Postgres + secrets + layout com sidebar | alto | idea | P3 | |
